...
void printFontTable() {
    ...
    x = x + 6;//move to next valid space

    if(x > 120){//128 - 6
        x = 0;//begin of a new line
        y = y + 8;//next row line
    }
...
void printFullName() {
    ...
    fillScreen(BLACK);
    drawChar(5, 29, 'Y', 0xFFFF, 0x0000, 1);
    drawChar(29, 29, 'a', 0xFFFF, 0x0000, 1);
    drawChar(53, 29, 'z', 0xFFFF, 0x0000, 1);
    drawChar(77, 29, 'h', 0xFFFF, 0x0000, 1);
    drawChar(101, 29, 'i', 0xFFFF, 0x0000, 1);
    drawChar(29, 93, 'f', 0xFFFF, 0x0000, 1);
    drawChar(53, 93, 'a', 0xFFFF, 0x0000, 1);
    drawChar(77, 93, 'n', 0xFFFF, 0x0000, 1);
}
//*****************************************************************************
void testHorizontalBand(){
    unsigned int y;
