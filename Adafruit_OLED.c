...
*/
    ...
    GPIOPinWrite(GPIOA0_BASE, 0x80, 0);//be low DC
    GPIOPinWrite(GPIOA3_BASE, 0x10, 0);//be low OC

    MAP_SPIDataPut(GSPI_BASE, c);
    MAP_SPIDataGet(GSPI_BASE, &ulDummy);

    GPIOPinWrite(GPIOA3_BASE, 0x10, 0x10);//be high
...
*/
    ...
    GPIOPinWrite(GPIOA3_BASE, 0x10, 0);//be low
    GPIOPinWrite(GPIOA0_BASE, 0x80, 0x80);//be high
    ...
    GPIOPinWrite(GPIOA0_BASE, 0x10, 0x10);//be high
    MAP_SPICSDisable(GSPI_BASE);
}
